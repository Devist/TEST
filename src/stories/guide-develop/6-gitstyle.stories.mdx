...
<div className="box">
  ...
  <br />
  Fix crash that happens when a component throws an exception that contains a
  null message
</div>
...
<div className="box">
  ...
  <br />
  Fix Android 28's inverted ScrollView so that momentum is in the proper
  direction
</div>
...
<div className="box">
  ...
  <br />
  Fix case where inline view is visible even though it should have been
  truncated
  <br />
  Fix issue where Image.resizeMode isn't respected while source is loading,
  resulting in unexpected padding
</div>
...
<div className="box">
  Update react-devtools-core and plist to include security fixes reported by npm
  audit
  <br />
...
<div className="box">
  ...
  Xcode warning
  <br />
  Implement an in-memory cache store to save parsed and validated documents and
  provide performance benefits for repeat executions of the same document
</div>
...
<div className="box">
  ...
  <br />
  Avoid "Member not found" exception in IE10 when calling preventDefault() in
  Synthetic Events.
  <br />
...
<div className="box">
  ...
  <br />
  Allow an optional function to resolve the rootValue, passing the DocumentNode
  AST to determine the value.
</div>
