...
<Meta title="for 운영자 /🧐 2.0 개발 가이드/컴포넌트 설계" />
...
이용중인 vuexy UI 템플릿 ( with react bootstrap ) 에 대부분의 atoms와 molecules는 이미 정의되어 있기 때문에, 저희는 대부분 organisms 이상의 컴포넌트만 설계합니다.

[컴포넌트 설계문서 바로가기 >](https://docs.google.com/spreadsheets/d/1_a5nQvRgmOLkIxFWsyPtREeZLSdRj61jFK6KL3U7YgE/)
...
- 보통 기본 html 태그로 이루어져 있되, 유저정보허브는 vuexy라는 UI 템플릿 사용하므로 vuexy 컴포넌트가 들어갈 수 있음
